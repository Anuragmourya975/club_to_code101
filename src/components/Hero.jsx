  ...
  return (
    <>
      ...
      <section className="pt-8 bg-black">
        <div className="px-12 mx-auto max-w-7xl invert">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight">
              <span>Start</span>{" "}
              <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-red-400 to-purple-500 lg:inline">
                building a buzz
              </span>{" "}
          ...
          <div className="w-full mx-auto mt-20 text-center md:w-10/12">
            <div className="relative z-0 w-full mt-8">
              <div className="relative overflow-hidden  ">
                <div className="flex items-center flex-none px-4 bg-red-400 rounded-b-none h-11 rounded-xl">
                ...
                {/* <img src={Heroimg} className="invert" /> */}
              </div>
            </div>
          </div>
          <About />
